# codes adapted from https://github.com/TsingZ0/PFL-Non-IID/blob/70d1a8f1a372eaabc3305a4566d15246031c8b8c/dataset/generate_cifar100.py
...
parser.add_argument('--dir', type=str, help='directory for storing the data',
                    default ="/mlodata1/dongyang/Cifar100/" )
...
def generate_cifar100(dir_path, num_clients, num_classes, niid, balance, partition,alpha,ref):
    ...
    train_data, test_data, ref_data = split_data(X, y)
...
if __name__ == "__main__":
    ...
    generate_cifar100(dir_path, num_clients, num_classes, niid, balance, partition,alpha,ref)